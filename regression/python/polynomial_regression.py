...
train_poly_features = poly.fit_transform(train_features)
print train_poly_features

#### TRAIN POLYNOMIAL MODEL ####
reg = linear_model.LinearRegression()
reg.fit(train_poly_features, train_targets)
...
#### PREDICT ####
preds = reg.predict(test_poly_features) 
